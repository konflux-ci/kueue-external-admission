...
import (
	...
	"github.com/konflux-ci/alert-manager-kueue-admission/test/utils"
)
...
var (
	...
	projectImage = "example.com/alert-manager-kueue-admission:v0.0.1"
)
...
func TestE2E(t *testing.T) {
	...
	_, _ = fmt.Fprintf(GinkgoWriter, "Starting alert-manager-kueue-admission integration test suite\n")
